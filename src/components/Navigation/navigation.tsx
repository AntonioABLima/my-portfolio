        ...
        <nav>
            <div className={`menu-btn ${isMenuOpen ? 'open' : ""}`}>
                ...
                <div style={{ display: "flex" }}>
                    ...
                    <a className={`btn ${isMenuOpen ? 'open' : ""}`} href="https://bsky.app/profile/edh.dev/" target="_blank">
                    ...
                    <a className={`btn ${isMenuOpen ? 'open' : ""}`} href="https://github.com/edhinrichsen/retro-computer-website" target="_blank">
                        <svg width="16" height="16">
